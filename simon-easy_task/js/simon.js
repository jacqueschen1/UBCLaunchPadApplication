...
var played = new Array; //current list of notes just played
var timer = 2500;
var countdown = setInterval(function(){timer-=500;}, 500);  //countdown increment for 2.5 seconds
//setInterval found online: https://stackoverflow.com/questions/14226803/wait-5-seconds-before-executing-next-line


//echo 
function echo(key){
	clearInterval(countdown) //resets countdown everytime a new note is pressed
	timer = 2500;
	played.push(key);   
	countdown = setInterval(function(){timer-=500}, 500); //restarts countdown
}

//checks if countdown reached 0 and echoes notes back, resets played list
setInterval(function(){
	if(timer <= 0){
		played.forEach(function(key, i) {
